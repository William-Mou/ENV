...
git clone https://github.com/William-Mou/ENV.git && mkdir -p /home/$(whoami)/ 
cp -r /home/ENV/VScode/extensions /home/$(whoami)/

# run coder-server
code-server1.1119-vsc1.33.1-linux-x64/code-server ./$(whoami) --extensions-dir="./$(whoami)/extensions/" --password="root"  && echo "done" || echo "run server error"
